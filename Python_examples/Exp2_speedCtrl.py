...
# 7Bot Robotic Arm Example 2: Robot Speed Control (Enhanced with WebSocket Support)
...
print("Starting speed control demonstration...")

# 1. set low motion speed
print("Setting low motion speed (20)...")
arm.setSpeed(20)
...
print("Setting high motion speed (70)...")
arm.setSpeed(70)
pose2 = [130,  100,  80,  130,  130,  130, 80]
arm.setAngles(pose2)
time.sleep(2)

print("Speed control demonstration completed!")
