...
# 7Bot Robotic Arm Example 4: Robot Motor Status Control (Enhanced with WebSocket Support)
...
print("Starting motor status control demonstration...")

# 1. set motor to status 0-protection
print("Setting motor to protection mode (status 0)...")
arm.setStatus(0)
time.sleep(3)

# 2. set motor to status 1-servo
print("Setting motor to servo mode (status 1)...")
arm.setStatus(1)
time.sleep(3)

# 3. set motor to status 2-forceless
print("Setting motor to forceless mode (status 2)...")
arm.setStatus(2)
time.sleep(3)

print("Motor status control demonstration completed!")
