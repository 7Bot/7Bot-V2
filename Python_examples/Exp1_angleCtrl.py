...
# 7Bot Robotic Arm Example 1: Robot Pose Control (Enhanced with WebSocket Support)
...
print("Starting angle control demonstration...")

# 1. set individual joint
id = 1
print(f"Moving joint {id} to 50 degrees...")
arm.setAngle(id, 50)
time.sleep(1.5)

print(f"Moving joint {id} to 90 degrees...")
arm.setAngle(id, 90)
time.sleep(1.5)

# 2. set all joints at once
print("Setting all joints to pose1...")
pose1 = [50,  80,  50,  50,  50,  50, 40]
arm.setAngles(pose1)
time.sleep(2)

print("Setting all joints to pose2...")
pose2 = [130,  100,  80,  130,  130,  130, 80]
arm.setAngles(pose2)
time.sleep(2)

print("Angle control demonstration completed!")
